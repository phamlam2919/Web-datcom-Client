            ...
            <div className="w-1/2 p-[30px]">
                ...
                >
                    ...
                    <p className="text-[#EAEAEF] text-center text-base font-medium flex flex-col justify-center w-[480px]">
                        ...
                        econev@gmail.com. Enter the code in the box below to
                        continue.
                    </p>
                    <div className="flex gap-3 mt-5">
                        <input
                            type="text"
                            className="h-[54px] rounded-2xl bg-[#3A3A3A] text-white w-[50px] text-center"
                    ...
                    <p className="text-white text-base font-medium mt-5 cursor-pointer">
                        Didn’t receive a code?{" "}
                        <b className="text-[#FFB01D]">Resend Code</b>
                    </p>
