                            ...
                            <div className="max-w-[370px] bg-white border border-gray-200 rounded-lg shadow dark:bg-[#FFFFFF] mt-10">
                                ...
                                <div className="p-5">
                                    ...
                                    <p className="mb-3 font-normal text-sm text-[#596a4d]">
                                        Zumwhere - nơi bắt đầu cuộc vui sau giờ
                                        làm với những món ăn fusion đa dạng,
                                        những ly bia thủ công, rượu và cocktail
                    ...
                    <div className="">
                        ...
                        <div className="flex justify-center mb-10">
                            <p className="text-center w-[800px]">
                                Đến với Anzi, bạn không cần bận tâm các vấn đề
                                vệ sinh an toàn thực phẩm. Với nguyên tắc "Cái
                                đức đặt lên hàng đầu", thức ăn từ khâu chọn lọc
                                đến khâu chế biến đều được đội ngũ bếp chăm chút
                                kỹ lưỡng !
                            </p>
                        </div>
                        <div className="flex justify-between">
                            ...
                            >
                                ...
                                <p>
                                    Thực phẩm chọn lọc kỹ càng, cam kết không sử
                                    dụng các hoá chất nhầm mục đích lợi nhuận{" "}
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <p>
                                    Món ăn chế biến khẩu vị đậm đà, đặc trưng
                                    hương vị Miền Tây vừa miệng nhiều thực khách
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <p>
                                    Thực đơn mới mỗi ngày, thường xuyên có các
                                    món mới lạ, không gây cảm giác gây ngán ăn
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between mt-7">
                            ...
                            >
                                ...
                                <p>
                                    Cố gắng giao thức ăn đến tay khách hàng
                                    nhanh nhất, món ăn vẫn còn nóng. Shipper dễ
                                    thương
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <p>
                                    Mỗi phần cơm RK gồm có: cơm, món mặn, canh,
                                    rau xào, trái cây tráng miệng, tăm và khăn
                                    ước
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <p>
                                    Đội ngũ RK luôn lắng nghe mọi ý kiến khách
                                    hàng để cải thiện chất lượng dịch vụ
                                </p>
                            </div>
                        </div>
                    </div>
